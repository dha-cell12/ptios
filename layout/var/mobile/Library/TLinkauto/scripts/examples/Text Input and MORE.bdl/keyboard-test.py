...
device.insert_text("This text is generated by TLinkauto!")
time.sleep(1.5)
...
text = device.set_clipboard_text("This content is saved by TLinkauto script")
time.sleep(1.5)
