...
- (void)viewDidLoad {
    ...
    if (![[NSUserDefaults standardUserDefaults] boolForKey:@"TLinkautoAlreadyLaunchedv0.0.6"])
    {
        ...
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"TLinkautoAlreadyLaunchedv0.0.6"];
        [[NSUserDefaults standardUserDefaults] synchronize];
    }
