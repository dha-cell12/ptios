...
- (void)viewDidLoad
{
    ...
    _sections = @[
        ...
        @[@"Color/Image/Frame: active", @"Screenshot Album: Photos access required", @"Vision OCR: active", @"Script Runtime: javascriptcore_mvp", @"Scheduler: streamd_lite + autolaunch", @"Touch Recording: iohid raw replay", @"Tap Macro: bounded async native tap", @"Hardware Key: hid keyboard event", @"Connectivity: best effort private framework", @"VPN: query only", @"Shell: gated local sh", @"Visual Feedback: foreground_overlay", @"Dialog Overlay: nonblocking", @"Keep Awake: foreground idle timer", @"Service Mode: helper ensure streamd", @"App/Process: helper launch/kill/url", @"Keyboard: clipboard text/image; text input limited", @"Activator: limited_on_trollstore", @"Privhelper: open_kill_restart_ensure"],
    ];
