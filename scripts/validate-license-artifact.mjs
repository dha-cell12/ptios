...
assert.ok(uiServiceBinary.includes("uiservice_ready;;version=12"), "TLinkUIService lacks v12 readiness evidence");
...
assert.equal(plistValue(uiServiceInfoXML, "CFBundleVersion"), "12", "TLinkUIService bundle version is stale");
