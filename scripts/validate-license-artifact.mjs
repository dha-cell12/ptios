...
assert.ok(uiServiceBinary.includes("uiservice_ready;;version=11"), "TLinkUIService lacks v11 readiness evidence");
...
assert.equal(plistValue(uiServiceInfoXML, "CFBundleVersion"), "11", "TLinkUIService bundle version is stale");
