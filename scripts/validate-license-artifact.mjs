...
assert.ok(streamdBinary.includes("vpnBackgroundAgent=candidate_mobile_process_v6_ne_profile_restore"), "streamd lacks VPN restored native-profile candidate evidence");
...
assert.ok(vpnagentBinary.includes("vpnagent_ready version=6 phase=5"), "vpnagent lacks P5 readiness evidence");
...
assert.ok(
  vpnagentEntitlements.includes("com.apple.SystemConfiguration.SCDynamicStore-write-access") &&
    vpnagentEntitlements.includes("com.apple.managedconfiguration.profiled-access"),
  "vpnagent is missing the private VPN profile commit entitlements",
);
assert.ok(
  vpnagentEntitlements.includes("com.apple.SystemConfiguration.SCDynamicStore-write-access") &&
    vpnagentEntitlements.includes("com.apple.managedconfiguration.profiled-access"),
...
assert.ok(
  appEntitlements.includes("com.apple.SystemConfiguration.SCDynamicStore-write-access") &&
    appEntitlements.includes("com.apple.managedconfiguration.profiled-access"),
  "StreamControl is missing the private VPN profile commit entitlements",
);
assert.ok(
  appEntitlements.includes("com.apple.SystemConfiguration.SCDynamicStore-write-access") &&
    appEntitlements.includes("com.apple.managedconfiguration.profiled-access"),
...
const manifest = {
  ...
  vpn_agent_version: 6,
  vpn_profile_bootstrap: "nevpnmanager_known_good_with_private_cleanup",
  config: {
