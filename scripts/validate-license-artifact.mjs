...
assert.ok(streamdBinary.includes("vpnBackgroundAgent=candidate_mobile_process_v5_private_profile_commit"), "streamd lacks VPN private profile-commit candidate evidence");
...
assert.ok(vpnagentBinary.includes("vpnagent_ready version=5 phase=5"), "vpnagent lacks P5 readiness evidence");
