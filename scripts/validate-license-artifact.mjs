...
assert.ok(uiServiceBinary.includes("uiservice_ready;;version=10"), "TLinkUIService lacks v10 readiness evidence");
...
assert.equal(plistValue(uiServiceInfoXML, "CFBundleVersion"), "10", "TLinkUIService bundle version is stale");
