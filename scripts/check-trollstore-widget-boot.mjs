...
assert.match(widgetSource, /context\.isPreview/);
assert.match(widgetSource, /entry\.status/);
assert.match(wakeHelper, /SBSLaunchApplicationWithIdentifierAndURLAndLaunchOptions/);
assert.match(wakeHelper, /SBSLaunchApplicationWithIdentifier/);
assert.match(wakeHelper, /SBSApplicationLaunchOptionUnlockDeviceKey/);
assert.match(wakeHelper, /LSApplicationWorkspace/);
assert.doesNotMatch(wakeHelper, /fileExistsAtPath:kTLinkBootEnabledMarkerPath/);
...
assert.match(wakeHelper, /launch_attempt_started/);
assert.match(wakeHelper, /launch_requested_full_sbs/);
