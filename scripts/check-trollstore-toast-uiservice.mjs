...
assert.match(source, /uiservice_ready;;version=9/);
...
assert.match(source, /launch_mode=UIKitPluginHostedFrontBoardScene/);
...
assert.match(helper, /containsString:@?"window_key=1"/);
...
assert.match(settings, /UI service v9/);
