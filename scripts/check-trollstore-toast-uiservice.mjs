...
assert.match(info, /<key>CFBundleVersion<\/key>\s*<string>11<\/string>/);
...
assert.match(source, /uiservice_ready;;version=11/);
...
assert.match(helper, /containsString:@?"version=11"/);
...
assert.match(settings, /UI service v11/);
