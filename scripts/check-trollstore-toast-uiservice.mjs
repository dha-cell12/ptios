...
assert.match(info, /<key>CFBundleVersion<\/key>\s*<string>10<\/string>/);
...
assert.match(source, /uiservice_ready;;version=10/);
...
assert.match(helper, /containsString:@?"version=10"/);
...
assert.match(settings, /UI service v10/);
