...
assert.match(info, /<key>CFBundleVersion<\/key>\s*<string>13<\/string>/);
...
assert.match(source, /uiservice_ready;;version=13/);
...
assert.match(source, /direct_uiview_and_catextlayer_no_animation/);
...
assert.match(helper, /containsString:@?"version=13"/);
...
assert.match(settings, /UI service v13/);
