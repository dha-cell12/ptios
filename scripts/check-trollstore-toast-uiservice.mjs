...
assert.match(info, /<key>CFBundleVersion<\/key>\s*<string>12<\/string>/);
...
assert.match(source, /uiservice_ready;;version=12/);
...
assert.match(helper, /containsString:@?"version=12"/);
...
assert.match(settings, /UI service v12/);
