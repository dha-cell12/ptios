...
assert.match(source, /uiservice_ready;;version=6/);
...
assert.match(source, /TLinkScheduleRestorePreviousApplication\(0\.25\)/);
assert.match(source, /toast complete; exiting ephemeral foreground service/);
assert.match(source, /no toast received; exiting invisible foreground service/);
...
assert.match(settings, /UI service v6/);
