...
- License Phase 5 adds corrupt-lease quarantine with cross-process generation notification, Keychain-backed public-key repair, device-limit recovery guidance, explicit clock tolerance diagnostics, and service v21 replacement so an update cannot keep an older daemon/config active.
