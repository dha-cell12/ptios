...
var _writer4, _readable, _socketLock, _writeLock, _combiner, _AdbSyncSocketLocked_instances, write_fn;
var AdbSyncSocketLocked = class {
  ...
  get position() {
    return __privateGet(this, _readable).position;
  }
  async flush() {
    try {
  ...
  async readExactly(length) {
    await this.flush();
    return await __privateGet(this, _readable).readExactly(length);
  }
  release() {
  ...
  async close() {
    await __privateGet(this, _readable).cancel();
  }
};
...
var _dispatcher, _readable2, _readableController, _writableController, _closed, _closedPromise, _socket6, _availableWriteBytesChanged, _availableWriteBytes, _AdbDaemonSocketController_instances, writeChunk_fn;
var AdbDaemonSocketController = class {
  constructor(options) {
    ...
    __privateSet(this, _readable2, new PushReadableStream((controller) => {
  ...
  async enqueue(data) {
    await __privateGet(this, _readableController).enqueue(data);
  }
  ack(bytes) {
    var _a;
...
var _connection2, _buffered, _writer6;
var AdbServerStream = class {
  constructor(connection) {
    ...
    __publicField(this, "readString", bipedal(function* (then) {
      ...
      if (length === 0) {
        ...
        let result = "";
        const iterator = __privateGet(this, _buffered).iterateExactly(length);
        while (true) {
    ...
    __privateSet(this, _buffered, new BufferedReadableStream(connection.readable));
    __privateSet(this, _writer6, connection.writable.getWriter());
  }
  readExactly(length) {
    return __privateGet(this, _buffered).readExactly(length);
  }
  async readOkay() {
  ...
  release() {
    ...
    return {
      readable: __privateGet(this, _buffered).release(),
  ...
  async dispose() {
    void tryCancel(__privateGet(this, _buffered));
...
//# sourceMappingURL=chunk-MHEXVRWM.js.map
