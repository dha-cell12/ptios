...
from zxtouch.screen import Screen
from zxtouch.transport import ZXTouchTransport
from zxtouch.app import App
import base64
import json
...
class zxtouch:
    def __init__(self, ip):
        ...
        self.s = ZXTouchTransport.connect(str(ip), 6000)
        time.sleep(0.1)
    ...
    def hello_status(self):
        """Probe ZXTouch and get device/script status (base64 JSON)."""
